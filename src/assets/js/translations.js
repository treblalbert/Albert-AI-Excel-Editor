const translations = {
    en: {
        ...
        shortcutsHint: "Double-click: Edit cell | F2: Edit mode | Enter: Confirm | Arrows: Navigate | Ctrl+C/X/V: Copy/Cut/Paste | Del: Clear",
        ...
        invalidResponseFormat: "Invalid response format from AI. The file may be too large.",
        largeDatasetWarning: "⚠️ Large dataset detected. Using sampling mode for AI operations.",
        rateLimitError: "Rate limit exceeded. Please wait a moment and try again.",
        requestTooLarge: "Request too large. Try selecting fewer rows or a simpler operation.",
        invalidApiKey: "Invalid API key. Please check your OpenAI API key.",
        serverError: "OpenAI server error. Please try again later.",
        trySimpler: "Try a simpler request or smaller dataset.",
    ...
    es: {
        ...
        shortcutsHint: "Doble clic para editar | F2: Modo edición | Enter: Confirmar | Flechas: Navegar | Ctrl+C/X/V: Copiar/Cortar/Pegar | Supr: Borrar",
        ...
        invalidResponseFormat: "Formato de respuesta inválido de la IA. El archivo puede ser demasiado grande.",
        largeDatasetWarning: "⚠️ Conjunto de datos grande detectado. Usando modo de muestreo para operaciones de IA.",
        exportXLSX: "Excel (.xlsx)",
        exportXLS: "Excel 97-2003 (.xls)",
        exportCSV: "CSV (.csv)",
        exportTSV: "TSV (.tsv)",
    ...
    ca: {
        ...
        shortcutsHint: "Doble clic per editar | F2: Mode edició | Enter: Confirmar | Fletxes: Navegar | Ctrl+C/X/V: Copiar/Tallar/Enganxar | Supr: Esborrar",
        ...
        invalidResponseFormat: "Format de resposta invàlid de la IA. L'arxiu pot ser massa gran.",
        largeDatasetWarning: "⚠️ Conjunt de dades gran detectat. Usant mode de mostreig per operacions d'IA.",
        exportXLSX: "Excel (.xlsx)",
        exportXLS: "Excel 97-2003 (.xls)",
        exportCSV: "CSV (.csv)",
        exportTSV: "TSV (.tsv)",
